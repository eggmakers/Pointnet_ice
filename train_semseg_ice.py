...
import argparse
import os
from data_utils.iceDataLoader import IceDataset
import torch
import datetime
import logging
...
def parse_args():
    ...
    parser.add_argument('--test_split', type=str, default='Area_2', help='Which area to use for test, option: Area_1-2 [default: Area_1]')
...
def main(args):
    ...
    root = 'D:/pn/Pointnet_ice/data/icedata_3d/'
    NUM_CLASSES = 3
    NUM_POINT = args.npoint
    BATCH_SIZE = args.batch_size

    print("start loading training data ...")
    TRAIN_DATASET = IceDataset(split='train', data_root=root, num_point=NUM_POINT, test_split=args.test_split, block_size=1.0, sample_rate=1.0, transform=None)
    print("start loading test data ...")
    TEST_DATASET = IceDataset(split='test', data_root=root, num_point=NUM_POINT, test_split=args.test_split, block_size=1.0, sample_rate=1.0, transform=None)
